		...
		<SafeAreaView style={styles.container}>
			...
			>
				...
				>
					...
					>
						<Foundation name='clipboard-notes' size={20} color={setColor(1)} />
						<Text
							style={[
								styles.topic,
								{
					...
					>
						<Entypo name='flow-line' size={20} color={setColor(1)} />
						<Text
							style={[
								styles.text,
								{
					...
					>
						<Ionicons name='checkmark-done' size={20} color={setColor(2)} />
					...
					>
						<Entypo name='flow-line' size={20} color={setColor(2)} />
						<Text
							style={[
								styles.text,
								{
					...
					>
						<FontAwesome5 name='people-carry' size={20} color={setColor(3)} />
						<Text
							style={[
								styles.topic,
								{
					...
					>
						<Entypo name='flow-line' size={20} color={setColor(3)} />
						<Text
							style={[
								styles.text,
								{
					...
					>
						<Entypo name='flow-line' size={20} color={setColor(4)} />
						<Text
							style={[
								styles.text,
								{
					...
					>
						<FontAwesome5 name='smile-beam' size={20} color={setColor(5)} />
						<Text
							style={[
								styles.topic,
								{
					...
					>
						<Entypo name='flow-line' size={20} color={setColor(5)} />
						<Text
							style={[
								styles.text,
								{
